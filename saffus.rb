...
class Saffus < Formula
  ...
  on_macos do
    if Hardware::CPU.intel?
      url "https://github.com/you54f/cirrus-cli/releases/download/v0.98.0/saffus-darwin-amd64.tar.gz"
    ...
    if Hardware::CPU.arm?
      url "https://github.com/you54f/cirrus-cli/releases/download/v0.98.0/saffus-darwin-arm64.tar.gz"
